...
class   EnemyPlane(pygame.sprite.Sprite):
    ...
    def __init__(self,screen):
        ...
        x = random.randrange(0,Manager.by_size[0],100)
...
class Manager():
    ...
    def main(self):
        ...
        self.new_player()
        #开启创建敌机的定时器
        pygame.time.set_timer(Manager.create_enemy_id,4000)     #每1000毫米创建一次
        ...
        while True:
            ...
            #判断碰撞
            # self.players指的是所有player = HeroPlane(self.screen)精灵子对象
            iscollide = pygame.sprite.groupcollide(self.players,self.enemys,True,True)
            # print(EnemyPlane.bullets, self.players,self.enemys)
            ...
            if iscollide1:
                ...
                #爆炸声音w
                self.sound.playBombSound()
                # EnemyPlane.bullets.empty()           #empty这个方法是用来清空精灵组的   撞一次就清空一个敌机子弹精灵组
