...
class   EnemyPlane(pygame.sprite.Sprite):
    ...
    def auto_fire(self):
        ...
        if random_num == 8:
            ...
            self.bullets.add(bullet)
            EnemyPlane.Ebullets.add(bullet)
    ...
    def main(self):
        ...
        while True:
            ...
            if self.players.sprites():
                isover = pygame.sprite.spritecollide(self.players.sprites()[0], EnemyPlane.Ebullets, True)
                if isover:
                    Manager.is_gave_over = True  # 标志游戏结束
            ...
            iscollide2 = pygame.sprite.groupcollide(self.players,EnemyPlane.Ebullets,True,True)
            if iscollide2:
                items = list(iscollide2.items())[0]
                x = items[1][0]
                self.enemy_bomb.action(x.rect)
                self.sound.playBombSound()
